...
\x1b[0;33m║#OWNER    : @I4m_palabun
\x1b[0;33m║#CHANEL: NAME [ @team_1996  ]  
\x1b[0;33m]         TB: free mod bakar bena [korak]
 \x1b[0;33m╚═══════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\033[1;93m[\033[1;94m01\033[1;97m] Dastpy Krdni Hack\033[1;93m [ \033[1;95m PRO \033[1;97m]")
	print("\033[1;93m[\033[1;94m00\033[1;97m] Darchun\033[1;97m [ \033[1;91mRash Krdnaway TOKEN \033[1;97m]")
	Bilal = raw_input("\n\033[1;96m[\033[1;93m+\033[1;96m] Halbzhera : ")
	if Bilal =="":
		menu()
		...
		cek = raw_input("\n\033[1;93m[\033[1;93m+\033[1;96m] Halbzhera : ")
		if cek =="":
			menu()
		elif cek == "1":
			dirs = os.listdir("OK")
